...
# ---------- Clans ----------
CLANS = {
    "Звездные стражи 🌌": "🛡 <b>Звездные стражи</b> — воины света, связанные с космосом и вечностью. Они охраняют равновесие и защищают мир от хаоса.",
    "Сияющие маяки 🔥": "🔥 <b>Сияющие маяки</b> — лидеры и проводники. Символизируют надежду, чистоту и силу духа. Их цель — быть светом во тьме для других.",
    "Тенистые клинки 🌑": "🌑 <b>Тенистые клинки</b> — мастера скрытности и внезапных ударов. Они действуют из тени, используя ловкость и точность как главное оружие.",
    "Безмолвные песни 🎵": "🎵 <b>Безмолвные песни</b> — мудрецы и мистики, владеющие древними знаниями и магией. Их сила кроется в тайне, тишине и внутреннем равновесии."
}
    ...
    if text == "👤 Профиль":
        ...
        if row:
            ...
            profile_text = (
                ...
                f"🥋 Экипировка:\n"
                f"Голова: {row['head']}, Тело: {row['body']}, Ноги: {row['legs']}, Ступни: {row['feet']}\n"
                f"Оружие: {row['weapon']}\n"
                f"Сумка: {row['bag']}\n\n"
